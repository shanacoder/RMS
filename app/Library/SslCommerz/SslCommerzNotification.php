...
//                    }
    ...
    {
        $this->data['total_amount'] = $info['total_amount']; // decimal (10,2)	Mandatory - The amount which will process by SSLCommerz. It shall be decimal value (10,2). Example : 55.40. The transaction amount must be from 10.00 INR to 500000.00 INR
        $this->data['currency'] = $info['currency']; // string (3)	Mandatory - The currency type must be mentioned. It shall be three characters. Example : INR, USD, EUR, SGD, INR, MYR, etc. If the transaction currency is not INR, then it will be converted to INR based on the current convert rate. Example : 1 USD = 82.22 INR.
